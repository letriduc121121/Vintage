...
//helper functioj to save to lcoalStỏage
...
//fetch carrt for a user or guest
    ...
    async ({userId,guestId},{rejectedWithValue})=>{
        try{
            const response=await axios.get(
                ...
                {
                    params: {userId,guestId},//Server sẽ kiểm tra một trong hai cái để lấy đúng giỏ hàng.
                }
...
export const addToCart=createAsyncThunk(
    "cart/addToCart",
    async ({productId,quantity,size,color,userId,guestId},{rejectedWithValue})=>{
        try{
...
export const updateCartItemQuantity=createAsyncThunk(
    'cart/updateCartItemQuantity',async ({productId,quantity,guestId,userId,size,color},{rejectedWithValue})=>{
        try{
...
export const removeFromCart=createAsyncThunk('cart/removeFromCart',async ({productId,guestId,userId,
...
//merge guest cart into user cart Gộp giỏ hàng của guest vào user khi đăng nhập
