    ...
    return(
        <>
            <nav className="container mx-auto flex items-center justify-between py-4 px-6">
                {/*left-logo */}
                <Link to="/" className="inline-block text-2xl italic font-serif text-amber-800 hover:scale-105 transition-transform duration-300 relative">
                ...
                <div className="hidden md:flex space-x-6">
                    ...
                    <div className="flex items-center space-x-4">
                        {user && user.role==="admin" &&(
                             <Link to="/admin" className="block bg-blue-800 px-2 rounded text-sm text-white">
                                 Admin
                            </Link>
                        )}
