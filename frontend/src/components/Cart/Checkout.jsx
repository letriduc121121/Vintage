...
const handleCreateCheckout=async (e)=>{
    ...
    if(cart &&cart.products.length>0){
        ...
        if(res.payload && res.payload._id){
            ...
            //ser checkout id if checkout was succesfull
        }
    }
    // setCheckoutId(123);
};
const handlePaymentSuccess=async(details)=>{
  ...
  return (
    ...
    tracking-tighter'>
        {/* khoi con ben trong nen trang bo goc nhe */}
                ...
                <div className='mb-4 grid grid-cols-2 gap-4'>
                    <div>
                        ...
                        <input 
                            ...
                            onChange={(e)=>setShippingAddress({...shippingAddress,
...
//                     checkoutItems: cart.products,
//                     shippingAddress,
//                     paymentMethod: 'CreditCard', // Example payment method
//                     totalPrice: cart.totalPrice,
//                 })
//             );
//             if (res.payload && res.payload._id) {
...
//             const response = await axios.put(
//                 `${import.meta.env.VITE_BACKEND_URL}/api/checkout/${checkoutId}/pay`,
//                 { paymentStatus: 'paid' }, // No payment details needed, since it's automatic
//                 {
//                     headers: {
//                         Authorization: `Bearer ${localStorage.getItem('userToken')}`,
//                     },
...
//             await handleFinalizeCheckout(checkoutId);
//             navigate('/order-confirmation'); // Redirect to order confirmation page after successful payment
