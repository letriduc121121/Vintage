...
const Register = () => {
    ...
    //copy lai
        ...
        //get redirect pararamter and check if it's checkoyt or something
    ...
    return (
        <div className='flex'>
            ...
            <form
                ...
                <button 
                    type="submit"
                    className='w-full bg-blue-800 text-white p-2 rounded-lg font-semibold hover:bg-gray-700 transition'
