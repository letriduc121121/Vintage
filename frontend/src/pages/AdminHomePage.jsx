      ...
      {productsLoading || ordersLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className='p-6 shadow-md rounded-lg'>
            ...
            <p className="text-xl font-semibold mt-2">${totalSales.toFixed(2)}</p>
          </div>
          ...
          <div className='p-6 shadow-md rounded-lg'>
            ...
            <p className="text-xl font-semibold mt-2">{products.length}</p>
            <Link to="/admin/products" className="text-blue-600 font-medium hover:underline">
              Manage Products
            </Link>
          </div>
        </div>
